...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container6").wowSlider({effect:"basic_linear",prev:"",next:"",duration:20*100,delay:40*100,width:640,height:300,autoPlay:true,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"slide",controls:true,logo:"engine6/loading.gif",onBeforeStep:0,images:0});